...
import com.example.photo.service.FileService;
...
public class FileResource {
    ...
    public void view(@RequestParam(name="key")String key, HttpServletResponse response) throws IOException {
        ...
        response.getOutputStream().write(object.getObjectContent().readAllBytes());//readAllBytes()
    }
    ...
    @DeleteMapping void delete(@RequestParam(name = "key")String key){
